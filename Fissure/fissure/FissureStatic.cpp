...
extern "C"
{
  ...
  uint64_t |_NAME_|(LavaParams* inout_lp, LavaFrame* in, lava_threadQ* out) noexcept
  {
    using namespace std;
...
//"  const char* OutTypes[]  = {\"IdxVerts\",           nullptr};            // This array contains the types that are output in each slot of the same index"
//""
//"  uint64_t TemplateTest(LavaParams* inout_lp, LavaFrame* in, lava_threadQ* out) noexcept"
//"  {"
//"    using namespace std;"
//""
//"    return 1;"
